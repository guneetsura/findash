...
export function TopCategoryCard() {
  ...
  return (
    ...
    >
      <div className="absolute top-0 right-0 w-32 h-32 bg-accent-violet/10 blur-[60px] rounded-full -mr-10 -mt-10" />
      
      <div className="relative z-10 flex items-center justify-between mb-8">
        <div className="flex items-center gap-2">
           <div className="p-2 bg-accent-violet/10 rounded-xl border border-accent-violet/20">
             <Trophy className="w-4 h-4 text-accent-violet" />
           </div>
           <span className="text-xs font-bold uppercase tracking-widest text-text-muted">Primary Outflow</span>
        </div>
      </div>
      ...
      <div className="relative z-10">
        {topCategory ? (
          <div className="flex flex-col gap-1">
            <h3 className="font-display text-4xl font-bold text-text-primary uppercase tracking-wider">
              {CATEGORY_LABELS[topCategory.category]}
            </h3>
            <p className="font-display text-2xl font-semibold text-accent-violet mt-1">
            ...
            <div className="mt-6">
              ...
              <div className="h-2 bg-surface-hover rounded-full overflow-hidden">
                 <motion.div
                   ...
                   className="h-full bg-accent-violet shadow-[0_0_10px_rgba(139,92,246,0.3)]"
                 />
              </div>
            </div>
          </div>
        ) : (
          <div className="flex flex-col items-center justify-center p-6 gap-2 text-text-muted">
